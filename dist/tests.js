...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./flight-search/flight-search-own-mock.spec.ts": 9,
		"./flight-search/flight-search.spec.ts": 10,
		"./flight-search/simple.spec.ts": 11
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("FlugList", function () {
	    ...
	    it("should load flights", function () {
	        ...
	        // Assert
	        expect(error).toBe(false);
	        expect(flightSearch.flights.length).toBe(2);
	    });
	});
